    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-white/5">
          <div className={`text-[10px] text-rose-300/40 text-center transition-opacity ${isCollapsed ? "opacity-0" : "opacity-100"}`}>
...
export function AppShellLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 overflow-hidden">
      ...
      <div className={`flex flex-1 flex-col transition-all duration-300 ${isCollapsed ? "md:ml-[78px]" : "md:ml-64"}`}>

        {/* Shell Header */}
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-slate-200/80 bg-white/80 px-4 shadow-sm backdrop-blur-md">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-white p-1 pr-4 shadow-sm">
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-rose-500 to-slate-900" />
